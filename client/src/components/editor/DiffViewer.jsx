    ...
    <div>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div className="p-4 rounded-xl bg-white/2 border border-white/5 text-sm text-neutral-500 leading-relaxed whitespace-pre-wrap max-h-72 overflow-y-auto">
            {original}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="p-4 rounded-xl bg-white/2 border border-white/5 text-sm text-neutral-300 leading-relaxed max-h-72 overflow-y-auto">
